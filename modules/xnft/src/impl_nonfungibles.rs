...
// 	fn system_attribute(collection: &Self::CollectionId, item: &Self::ItemId, key: &[u8]) ->
// Option<Vec<u8>> { 		<ExecutorOf<T>>::system_attribute(collection, item, key)
// 	}
...
// 	fn typed_collection_attribute<K: Encode, V: Decode>(collection: &Self::CollectionId, key: &K) ->
// Option<V> { 		<ExecutorOf<T>>::typed_collection_attribute(collection, key)
// 	}
